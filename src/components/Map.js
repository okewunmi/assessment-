...
const Map = ({ listings }) => {
  ...
  return (
    <>
      ...
      <div
        className="fixed bottom-0 left-0 right-0 w-full bg-gray-200 z-50 overflow-hidden rounded-t-lg"
...
// const mapContainerStyle = {
//   width: "100vw",
//   height: "86vh", // Map takes full width, 86vh height to leave room for the draggable section
// };
...
//       {/* Draggable Related File */}
//       <div
//         className="fixed bottom-0 left-0 w-full bg-gray-200 z-50 overflow-hidden"
//         style={{ height: `${relatedFileHeight}px` }} // Dynamic height
//       >
//         <div
//           className="cursor-ns-resize bg-blue-700 h-4"
//           onMouseDown={handleMouseDown}
//         ></div>
//         <RelatedFile />
//       </div>
